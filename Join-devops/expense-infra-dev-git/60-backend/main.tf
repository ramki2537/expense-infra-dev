...
# Terminating instance after creating AMI
resource "null_resource" "backend_delete" {

  triggers = {
    instance_id = aws.instance.backend.id
  }
...
#create aws target group terraform
...
# creating alb listener rule in terraform
resource "aws_lb_listener_rule" "backend" {
  listener_arn = data.aws_ssm_parameter.app_alb_listenar_arn.value
  priority     = 10
